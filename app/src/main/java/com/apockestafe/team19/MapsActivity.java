...
public class MapsActivity extends FragmentActivity implements OnMapReadyCallback {
    ...
    public void onMapReady(GoogleMap googleMap) {
        ...
        LatLng eventLocation = new LatLng(35, -119);

        float zoomLevel = (float) 15.0;
        mMap.addMarker(new MarkerOptions().position(rideLocation).title("Pickup Location")); //.icon(BitmapFactory.decodeResource(getResources(), R.drawable.user_picture_image)));
